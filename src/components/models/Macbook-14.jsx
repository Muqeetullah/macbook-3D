...
import { MACBOOK_MODEL_PATH, MACBOOK_SCREEN_PATH } from "../../constants/assets.js";

export default function MacbookModel14(props) {
    const { color } = useMacbookStore();
  const { nodes, materials, scene } = useGLTF(MACBOOK_MODEL_PATH);

  const texture = useTexture(MACBOOK_SCREEN_PATH);
